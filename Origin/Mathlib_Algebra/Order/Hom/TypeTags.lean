/-
Extracted from Algebra/Order/Hom/TypeTags.lean
...
-- INSTANCE (free from Core): Additive.instUniqueOrderAddMonoidIso

-- INSTANCE (free from Core): Multiplicative.instUniqueOrderdMonoidIso
