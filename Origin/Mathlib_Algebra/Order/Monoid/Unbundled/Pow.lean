/-
Extracted from Algebra/Order/Monoid/Unbundled/Pow.lean
Genuine: 26 | Conflates: 0 | Dissolved: 11 | Infrastructure: 0
-/
import Origin.Core
...
-- DISSOLVED: pow_le_pow_mul_of_sq_le_mul
...
-- DISSOLVED: StrictMono.pow_const

-- DISSOLVED: pow_left_strictMono
...
-- DISSOLVED: one_le_pow_iff

-- DISSOLVED: pow_le_one_iff

-- DISSOLVED: one_lt_pow_iff

-- DISSOLVED: pow_lt_one_iff

-- DISSOLVED: pow_eq_one_iff
