...
-- DISSOLVED: isCancelMulZero_iff_noZeroDivisors

-- DISSOLVED: NoZeroDivisors.to_isDomain
...
-- DISSOLVED: isDomain_iff_noZeroDivisors_and_nontrivial

-- DISSOLVED: noZeroDivisors_iff_isDomain_or_subsingleton
