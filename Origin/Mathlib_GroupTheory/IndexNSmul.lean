/-
Extracted from GroupTheory/IndexNSmul.lean
...
-- DISSOLVED: distribSMulToLinearMap_injective_of_isTorsionFree

-- DISSOLVED: nsmulAddMonoidHom_injective_of_isTorsionFree
