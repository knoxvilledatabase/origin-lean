/-
Extracted from CategoryTheory/Generator/Basic.lean
Genuine: 123 of 131 | Dissolved: 0 | Infrastructure: 8
-/
import Origin.Core
...
-- INSTANCE (free from Core): HasDetector.wellPowered

-- INSTANCE (free from Core): HasSeparator.wellPowered
