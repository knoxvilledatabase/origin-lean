/-
Extracted from CategoryTheory/Presentable/StrongGenerator.lean
...
-- INSTANCE (free from Core): ObjectProperty.isCardinalFiltered_costructuredArrow_colimitsCardinalClosure_ι

-- INSTANCE (free from Core): ObjectProperty.isFiltered_costructuredArrow_colimitsCardinalClosure_ι
