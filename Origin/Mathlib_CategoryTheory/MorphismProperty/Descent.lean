/-
Extracted from CategoryTheory/MorphismProperty/Descent.lean
...
-- INSTANCE (free from Core): DescendsAlong.top

-- INSTANCE (free from Core): DescendsAlong.inf
...
-- INSTANCE (free from Core): [Q.IsStableUnderBaseChange]

set_option backward.isDefEq.respectTransparency false in

-- INSTANCE (free from Core): [HasPullbacks
...
-- INSTANCE (free from Core): CodescendsAlong.top

-- INSTANCE (free from Core): CodescendsAlong.inf

-- INSTANCE (free from Core): [Q.IsStableUnderCobaseChange]
