...
Genuine: 21 of 49 | Dissolved: 0 | Infrastructure: 28
-/
import Origin.Core
...
-- INSTANCE (free from Core): IsFiltered.under

-- INSTANCE (free from Core): IsCofiltered.over

-- INSTANCE (free from Core): Under.final_forget

-- INSTANCE (free from Core): Over.initial_forget
...
-- INSTANCE (free from Core): [IsFilteredOrEmpty

-- INSTANCE (free from Core): Functor.final_diag_of_isFiltered
...
-- INSTANCE (free from Core): [IsCofilteredOrEmpty

-- INSTANCE (free from Core): Functor.initial_diag_of_isFiltered
...
-- INSTANCE (free from Core): StructuredArrow.final_proj_of_isFiltered

-- INSTANCE (free from Core): CostructuredArrow.initial_proj_of_isCofiltered

set_option backward.isDefEq.respectTransparency false in

-- INSTANCE (free from Core): StructuredArrow.final_map₂_id

set_option backward.isDefEq.respectTransparency false in

-- INSTANCE (free from Core): StructuredArrow.final_map

-- INSTANCE (free from Core): StructuredArrow.final_post

-- INSTANCE (free from Core): CostructuredArrow.initial_map₂_id

-- INSTANCE (free from Core): CostructuredArrow.initial_post
...
-- INSTANCE (free from Core): final_eval

open IsCofiltered in

-- INSTANCE (free from Core): initial_eval
