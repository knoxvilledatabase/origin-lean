/-
Extracted from CategoryTheory/Limits/Shapes/Pullback/IsPullback/Basic.lean
Genuine: 66 of 79 | Dissolved: 0 | Infrastructure: 13
-/
import Origin.Core
...
-- INSTANCE (free from Core): [HasPullbacksAlong
