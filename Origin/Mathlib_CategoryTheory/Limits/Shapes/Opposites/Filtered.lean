/-
Extracted from CategoryTheory/Limits/Shapes/Opposites/Filtered.lean
...
-- INSTANCE (free from Core): has_cofiltered_limits_op_of_has_filtered_colimits
...
-- INSTANCE (free from Core): has_filtered_colimits_op_of_has_cofiltered_limits
