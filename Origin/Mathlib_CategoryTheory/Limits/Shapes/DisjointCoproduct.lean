...
-- INSTANCE (free from Core): _root_.CategoryTheory.Mono.ι_of_coproductDisjoint
...
-- INSTANCE (free from Core): _root_.CategoryTheory.Mono.inl_of_binaryCoproductDisjoint

-- INSTANCE (free from Core): _root_.CategoryTheory.Mono.inr_of_binaryCoproductDisjoint
