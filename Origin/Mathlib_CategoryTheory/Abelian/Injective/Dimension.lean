/-
Extracted from CategoryTheory/Abelian/Injective/Dimension.lean
Genuine: 27 of 34 | Dissolved: 0 | Infrastructure: 7
-/
import Origin.Core
...
-- INSTANCE (free from Core): [HasInjectiveDimensionLT

-- INSTANCE (free from Core): [HasInjectiveDimensionLT

-- INSTANCE (free from Core): [HasInjectiveDimensionLT

-- INSTANCE (free from Core): [Injective
