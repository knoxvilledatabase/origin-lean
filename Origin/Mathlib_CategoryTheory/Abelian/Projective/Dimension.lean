/-
Extracted from CategoryTheory/Abelian/Projective/Dimension.lean
Genuine: 29 of 36 | Dissolved: 0 | Infrastructure: 7
-/
import Origin.Core
...
-- INSTANCE (free from Core): [HasProjectiveDimensionLT
