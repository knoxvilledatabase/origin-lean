/-
Extracted from Topology/Compactness/CompactlyCoherentSpace.lean
...
-- INSTANCE (free from Core): of_weaklyLocallyCompactSpace

-- INSTANCE (free from Core): of_sequentialSpace
