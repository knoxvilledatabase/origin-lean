...
-- INSTANCE (free from Core): Pi.locallyConvexSpace

-- INSTANCE (free from Core): Prod.locallyConvexSpace

end LatticeOps

section LinearOrderedSemiring

-- INSTANCE (free from Core): LinearOrderedSemiring.toLocallyConvexSpace
