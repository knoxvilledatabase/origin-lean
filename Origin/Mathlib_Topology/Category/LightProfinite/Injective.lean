/-
Extracted from Topology/Category/LightProfinite/Injective.lean
...
-- INSTANCE (free from Core): injective_of_finite

set_option backward.isDefEq.respectTransparency false in

-- INSTANCE (free from Core): injective_of_light

end Profinite

-- INSTANCE (free from Core): LightProfinite.injective
