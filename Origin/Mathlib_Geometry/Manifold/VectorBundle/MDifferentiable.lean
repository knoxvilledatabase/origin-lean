/-
Extracted from Geometry/Manifold/VectorBundle/MDifferentiable.lean
Genuine: 64 of 72 | Dissolved: 8 | Infrastructure: 0
-/
import Origin.Core
...
-- DISSOLVED: MDifferentiableWithinAt.sum_section_of_locallyFinite

-- DISSOLVED: MDifferentiableAt.sum_section_of_locallyFinite

-- DISSOLVED: MDifferentiableOn.sum_section_of_locallyFinite

-- DISSOLVED: MDifferentiable.sum_section_of_locallyFinite

-- DISSOLVED: MDifferentiableWithinAt.finsum_section_of_locallyFinite

-- DISSOLVED: MDifferentiableAt.finsum_section_of_locallyFinite

-- DISSOLVED: MDifferentiableOn.finsum_section_of_locallyFinite

-- DISSOLVED: MDifferentiable.finsum_section_of_locallyFinite
