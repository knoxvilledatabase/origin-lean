/-
Extracted from MeasureTheory/Integral/IntervalIntegral/FundThmCalculus.lean
Genuine: 64 of 72 | Dissolved: 0 | Infrastructure: 8
-/
import Origin.Core
...
-- INSTANCE (free from Core): pure

-- INSTANCE (free from Core): nhdsWithinSingleton
...
-- INSTANCE (free from Core): nhds

-- INSTANCE (free from Core): nhdsUniv

-- INSTANCE (free from Core): nhdsLeft

-- INSTANCE (free from Core): nhdsRight

-- INSTANCE (free from Core): nhdsIcc

-- INSTANCE (free from Core): nhdsUIcc
