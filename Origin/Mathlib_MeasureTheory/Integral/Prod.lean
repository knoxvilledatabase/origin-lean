...
Genuine: 57 of 65 | Dissolved: 8 | Infrastructure: 0
-/
import Origin.Core
...
-- DISSOLVED: MeasureTheory.AEStronglyMeasurable.of_comp_snd

-- DISSOLVED: MeasureTheory.AEStronglyMeasurable.of_comp_fst

-- DISSOLVED: MeasureTheory.AEStronglyMeasurable.comp_fst_iff

-- DISSOLVED: MeasureTheory.AEStronglyMeasurable.comp_snd_iff
...
-- DISSOLVED: Integrable.of_comp_snd

-- DISSOLVED: Integrable.of_comp_fst

-- DISSOLVED: Integrable.comp_snd_iff

omit [SFinite ν] in

-- DISSOLVED: Integrable.comp_fst_iff
