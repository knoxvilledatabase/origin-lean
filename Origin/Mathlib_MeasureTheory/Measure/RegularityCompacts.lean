/-
Extracted from MeasureTheory/Measure/RegularityCompacts.lean
...
-- INSTANCE (free from Core): instInnerRegularOfIsCompletelyPseudoMetrizableSpace

-- INSTANCE (free from Core): instInnerRegularCompactLTTopOfIsCompletelyPseudoMetrizableSpace
