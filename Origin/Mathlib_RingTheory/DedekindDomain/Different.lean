...
Genuine: 35 | Conflates: 0 | Dissolved: 11 | Infrastructure: 1
-/
import Origin.Core
...
-- DISSOLVED: dual_mul_self

-- DISSOLVED: self_mul_dual
...
-- DISSOLVED: differentialIdeal_le_fractionalIdeal_iff
...
-- DISSOLVED: pow_sub_one_dvd_differentIdeal_aux
