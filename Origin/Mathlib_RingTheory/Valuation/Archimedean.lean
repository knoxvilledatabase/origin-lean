/-
Extracted from RingTheory/Valuation/Archimedean.lean
...
-- INSTANCE (free from Core): MonoidWithZeroHom.instLinearOrderedCommGroupWithZeroMrange

-- INSTANCE (free from Core): Valuation.instLinearOrderedCommGroupWithZeroMrange
