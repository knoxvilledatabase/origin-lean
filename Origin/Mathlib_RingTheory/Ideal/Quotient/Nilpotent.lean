/-
Extracted from RingTheory/Ideal/Quotient/Nilpotent.lean
...
-- DISSOLVED: Ideal.Quotient.isUnit_mk_pow_iff_isUnit_mk

-- DISSOLVED: Ideal.Quotient.isUnit_mk_pow_iff_notMem
