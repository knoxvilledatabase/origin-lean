/-
Extracted from RingTheory/Ideal/Int.lean
...
-- INSTANCE (free from Core): Int.ideal_span_isMaximal_of_prime
...
-- INSTANCE (free from Core): liesOver_span_absNorm
...
-- DISSOLVED: Nat.absNorm_under_prime
