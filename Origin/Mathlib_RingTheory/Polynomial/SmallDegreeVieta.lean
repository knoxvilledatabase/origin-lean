/-
Extracted from RingTheory/Polynomial/SmallDegreeVieta.lean
Genuine: 5 of 9 | Dissolved: 4 | Infrastructure: 0
-/
import Origin.Core
...
-- DISSOLVED: roots_quadratic_eq_pair_iff_of_ne_zero

-- DISSOLVED: aroots_quadratic_eq_pair_iff_of_ne_zero
