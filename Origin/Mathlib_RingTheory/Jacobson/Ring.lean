/-
Extracted from RingTheory/Jacobson/Ring.lean
Genuine: 32 of 38 | Dissolved: 1 | Infrastructure: 5
-/
import Origin.Core
...
-- DISSOLVED: jacobson_bot_of_integral_localization
...
-- INSTANCE (free from Core): [IsJacobsonRing
