...
-- DISSOLVED: ne_zero_iff_weightedOrder_finite
...
-- DISSOLVED: exists_coeff_ne_zero_and_weightedOrder

-- DISSOLVED: weightedOrder_le
...
-- DISSOLVED: weightedOrder_eq_nat
...
-- DISSOLVED: weightedOrder_monomial_of_ne_zero
...
-- DISSOLVED: ne_zero_iff_exists_coeff_ne_zero_and_degree
...
-- DISSOLVED: ne_zero_iff_order_finite

@[simp] theorem order_eq_top_iff : f.order = ⊤ ↔ f = 0 :=
  weightedOrder_eq_top_iff _

-- DISSOLVED: exists_coeff_ne_zero_and_order
