/-
Extracted from RingTheory/TensorProduct/Finite.lean
...
-- INSTANCE (free from Core): Module.Finite.base_change

-- INSTANCE (free from Core): Module.Finite.tensorProduct
