...
-- INSTANCE (free from Core): instInhabited_fg
...
-- INSTANCE (free from Core): FG.instCountable_hom
...
-- INSTANCE (free from Core): Fg.instCountable_embedding
...
-- INSTANCE (free from Core): Substructure.instCountable_fg_substructures_of_countable
