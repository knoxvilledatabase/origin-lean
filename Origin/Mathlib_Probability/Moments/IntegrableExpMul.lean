/-
Extracted from Probability/Moments/IntegrableExpMul.lean
Genuine: 33 of 44 | Dissolved: 10 | Infrastructure: 1
-/
import Origin.Core
...
-- DISSOLVED: rpow_abs_le_mul_max_exp

-- DISSOLVED: rpow_abs_le_mul_exp_abs
...
-- DISSOLVED: integrable_rpow_abs_mul_exp_of_integrable_exp_mul

-- DISSOLVED: integrable_pow_abs_mul_exp_of_integrable_exp_mul

-- DISSOLVED: integrable_rpow_mul_exp_of_integrable_exp_mul

-- DISSOLVED: integrable_pow_mul_exp_of_integrable_exp_mul

-- DISSOLVED: integrable_rpow_abs_of_integrable_exp_mul

-- DISSOLVED: integrable_pow_abs_of_integrable_exp_mul

-- DISSOLVED: integrable_rpow_of_integrable_exp_mul

-- DISSOLVED: integrable_pow_of_integrable_exp_mul
