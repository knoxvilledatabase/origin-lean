/-
Generated by origin.py from Probability/Distributions/Gaussian/HasGaussianLaw/Independence.lean
...
/-! # Probability.Distributions.Gaussian.HasGaussianLaw on Option α -/
