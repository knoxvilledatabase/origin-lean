/-
Extracted from Probability/Kernel/Disintegration/CDFToKernel.lean
Genuine: 43 of 46 | Dissolved: 0 | Infrastructure: 3
-/
import Origin.Core
...
-- INSTANCE (free from Core): instIsMarkovKernel_toKernel
