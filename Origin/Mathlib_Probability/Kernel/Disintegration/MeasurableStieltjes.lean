...
-- INSTANCE (free from Core): IsMeasurableRatCDF.instIsProbabilityMeasure_stieltjesFunction
...
-- INSTANCE (free from Core): instIsProbabilityMeasure_stieltjesOfMeasurableRat
