/-
Extracted from FieldTheory/RatFunc/Luroth.lean
Genuine: 55 of 68 | Dissolved: 12 | Infrastructure: 1
-/
import Origin.Core
...
-- DISSOLVED: Φ_coeff_φ_natDegree_ne_zero
...
-- DISSOLVED: Φ_coeff_generatorIndex_ne_zero
