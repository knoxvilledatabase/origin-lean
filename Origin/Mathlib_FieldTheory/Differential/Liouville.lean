/-
Extracted from FieldTheory/Differential/Liouville.lean
...
-- INSTANCE (free from Core): IsLiouville.rfl
...
-- INSTANCE (free from Core): isLiouville_of_finiteDimensional_galois

-- INSTANCE (free from Core): isLiouville_of_finiteDimensional
