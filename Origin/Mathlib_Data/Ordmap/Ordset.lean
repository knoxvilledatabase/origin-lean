...
Genuine: 79 of 87 | Dissolved: 0 | Infrastructure: 8
-/
import Origin.Core
...
-- INSTANCE (free from Core): instEmptyCollection

-- INSTANCE (free from Core): instInhabited

-- INSTANCE (free from Core): instSingleton
...
-- INSTANCE (free from Core): instMembership

-- INSTANCE (free from Core): mem.decidable
