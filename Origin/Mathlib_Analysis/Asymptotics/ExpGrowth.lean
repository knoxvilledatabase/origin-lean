/-
Extracted from Analysis/Asymptotics/ExpGrowth.lean
Genuine: 52 of 69 | Dissolved: 15 | Infrastructure: 2
-/
import Origin.Core
...
-- DISSOLVED: expGrowthInf_const

-- DISSOLVED: expGrowthSup_const
...
-- DISSOLVED: expGrowthInf_of_eventually_ge

-- DISSOLVED: expGrowthSup_of_eventually_ge
...
-- DISSOLVED: expGrowthSup_comp_le

/-! ### Monotone sequences -/

-- DISSOLVED: _root_.Monotone.expGrowthInf_nonneg

-- DISSOLVED: _root_.Monotone.expGrowthSup_nonneg

-- DISSOLVED: expGrowthInf_comp_nonneg

-- DISSOLVED: expGrowthSup_comp_nonneg

-- DISSOLVED: _root_.Monotone.expGrowthInf_comp_le

-- DISSOLVED: _root_.Monotone.le_expGrowthSup_comp

-- DISSOLVED: _root_.Monotone.expGrowthInf_comp

-- DISSOLVED: _root_.Monotone.expGrowthSup_comp

-- DISSOLVED: _root_.Monotone.expGrowthInf_comp_mul

-- DISSOLVED: _root_.Monotone.expGrowthSup_comp_mul
