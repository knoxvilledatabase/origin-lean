/-
Extracted from Analysis/LocallyConvex/AbsConvexOpen.lean
...
-- INSTANCE (free from Core): AbsConvexOpenSets.instCoeOut
...
-- INSTANCE (free from Core): AbsConvexOpenSets.instNonempty
...
-- INSTANCE (free from Core): LocallyConvexSpace.toPolynormableSpace
