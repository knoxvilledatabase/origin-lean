/-
Extracted from Analysis/Normed/Module/MultipliableUniformlyOn.lean
Genuine: 11 of 13 | Dissolved: 2 | Infrastructure: 0
-/
import Origin.Core
...
-- DISSOLVED: hasProdUniformlyOn_of_clog

-- DISSOLVED: multipliableUniformlyOn_of_clog
