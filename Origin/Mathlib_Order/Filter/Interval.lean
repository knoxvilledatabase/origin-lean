...
-- INSTANCE (free from Core): tendsto_Icc_atTop_atTop

-- INSTANCE (free from Core): tendsto_Ico_atTop_atTop

-- INSTANCE (free from Core): tendsto_Ioc_atTop_atTop

-- INSTANCE (free from Core): tendsto_Ioo_atTop_atTop

-- INSTANCE (free from Core): tendsto_Icc_atBot_atBot

-- INSTANCE (free from Core): tendsto_Ico_atBot_atBot

-- INSTANCE (free from Core): tendsto_Ioc_atBot_atBot

-- INSTANCE (free from Core): tendsto_Ioo_atBot_atBot

-- INSTANCE (free from Core): OrdConnected.tendsto_Icc

-- INSTANCE (free from Core): tendsto_Ico_Ici_Ici

-- INSTANCE (free from Core): tendsto_Ico_Ioi_Ioi

-- INSTANCE (free from Core): tendsto_Ico_Iic_Iio

-- INSTANCE (free from Core): tendsto_Ico_Iio_Iio

-- INSTANCE (free from Core): tendsto_Ioc_Ici_Ioi

-- INSTANCE (free from Core): tendsto_Ioc_Iic_Iic

-- INSTANCE (free from Core): tendsto_Ioc_Iio_Iio

-- INSTANCE (free from Core): tendsto_Ioc_Ioi_Ioi

-- INSTANCE (free from Core): tendsto_Ioo_Ici_Ioi

-- INSTANCE (free from Core): tendsto_Ioo_Iic_Iio

-- INSTANCE (free from Core): tendsto_Ioo_Ioi_Ioi

-- INSTANCE (free from Core): tendsto_Ioo_Iio_Iio

-- INSTANCE (free from Core): tendsto_Icc_Icc_Icc

-- INSTANCE (free from Core): tendsto_Ioc_Icc_Icc
...
-- INSTANCE (free from Core): tendsto_Icc_pure_pure

-- INSTANCE (free from Core): tendsto_Ico_pure_bot

-- INSTANCE (free from Core): tendsto_Ioc_pure_bot

-- INSTANCE (free from Core): tendsto_Ioo_pure_bot
...
-- INSTANCE (free from Core): tendsto_Icc_uIcc_uIcc

-- INSTANCE (free from Core): tendsto_Ioc_uIcc_uIcc

-- INSTANCE (free from Core): tendsto_uIcc_of_Icc
