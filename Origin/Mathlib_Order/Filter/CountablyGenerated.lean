/-
Extracted from Order/Filter/CountablyGenerated.lean
Genuine: 20 of 27 | Dissolved: 0 | Infrastructure: 7
-/
import Origin.Core
...
-- INSTANCE (free from Core): Nat.inhabitedCountableFilterBasis
...
-- INSTANCE (free from Core): Inf.isCountablyGenerated

-- INSTANCE (free from Core): map.isCountablyGenerated

-- INSTANCE (free from Core): comap.isCountablyGenerated

-- INSTANCE (free from Core): Sup.isCountablyGenerated

-- INSTANCE (free from Core): prod.isCountablyGenerated

-- INSTANCE (free from Core): coprod.isCountablyGenerated
