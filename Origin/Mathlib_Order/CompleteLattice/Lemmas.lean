/-
Extracted from Order/CompleteLattice/Lemmas.lean
Genuine: 36 of 44 | Dissolved: 0 | Infrastructure: 8
-/
import Origin.Core
...
-- INSTANCE (free from Core): supSet

-- INSTANCE (free from Core): infSet
...
-- INSTANCE (free from Core): instCompleteLattice

end ULift

namespace PUnit

-- INSTANCE (free from Core): instCompleteLinearOrder
