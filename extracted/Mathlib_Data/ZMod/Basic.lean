...
-- DISSOLVED: natCast_eq_iff

-- DISSOLVED: intCast_eq_iff
...
-- DISSOLVED: cast_injective_of_le

-- DISSOLVED: cast_zmod_eq_zero_iff_of_le
...
-- DISSOLVED: val_add_val_of_le

-- DISSOLVED: val_add_of_le
...
-- DISSOLVED: val_cast_zmod_lt

-- DISSOLVED: neg_val'

-- DISSOLVED: neg_val

-- DISSOLVED: val_neg_of_ne_zero

-- DISSOLVED: val_sub

-- DISSOLVED: val_cast_eq_val_of_lt

-- DISSOLVED: cast_cast_zmod_of_le
...
-- DISSOLVED: valMinAbs_natAbs_eq_min
...
-- DISSOLVED: valMinAbs_natCast_eq_self
...
-- DISSOLVED: ZModModule.two_le_char

-- DISSOLVED: ZModModule.periodicPts_add_left
...
-- DISSOLVED: Nat.residueClassesEquiv
