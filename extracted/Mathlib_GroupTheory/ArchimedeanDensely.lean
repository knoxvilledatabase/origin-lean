...
Genuine: 8 | Conflates: 5 | Dissolved: 4 | Infrastructure: 1
-/
import Origin.Core
...
-- CONFLATES (assumes ground = zero): denselyOrdered_units_iff
...
-- DISSOLVED: LinearOrderedCommGroupWithZero.discrete_or_denselyOrdered

open WithZero in

-- DISSOLVED: LinearOrderedCommGroupWithZero.discrete_iff_not_denselyOrdered
...
-- DISSOLVED: LinearOrderedCommGroupWithZero.wellFoundedOn_setOf_le_lt_iff_nonempty_discrete_of_ne_zero

-- DISSOLVED: LinearOrderedCommGroupWithZero.wellFoundedOn_setOf_ge_gt_iff_nonempty_discrete_of_ne_zero
