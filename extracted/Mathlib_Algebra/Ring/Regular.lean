/-
Extracted from Algebra/Ring/Regular.lean
Genuine: 3 | Conflates: 1 | Dissolved: 2 | Infrastructure: 2
-/
import Origin.Core
...
-- DISSOLVED: NoZeroDivisors.toCancelMonoidWithZero

-- DISSOLVED: NoZeroDivisors.toCancelCommMonoidWithZero
