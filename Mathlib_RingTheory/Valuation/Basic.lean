...
Genuine: 106 | Conflates: 7 | Dissolved: 1 | Infrastructure: 16
-/
import Origin.Core
...
-- CONFLATES (assumes ground = zero): ne_zero_of_isUnit
...
-- CONFLATES (assumes ground = zero): ne_top_iff
